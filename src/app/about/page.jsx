...
const AboutPage = () => {
  const cards = [
    { icon: <FaUser />, title: "Who I Am", desc: "A dedicated Frontend Developer based in Bangladesh, focused on crafting clean and intuitive UI/UX.", color: "hover:shadow-indigo-500/20" },
    { icon: <FaGraduationCap />, title: "Education", desc: "Currently pursuing a Diploma in Computer Science & Technology at Habiganj Polytechnic Institute.", color: "hover:shadow-cyan-500/20" },
    { icon: <FaLaptopCode />, title: "Tech Stack", desc: "Expertise in React, Next.js, Tailwind CSS, and exploring Backend with MongoDB.", color: "hover:shadow-purple-500/20" },
    { icon: <FaRocket />, title: "The Goal", desc: "Aiming to bridge the gap between design and functionality as a Full-Stack Engineer.", color: "hover:shadow-pink-500/20" },
  ];
