          ...
          >
            ...
            <div className="flex gap-4 pt-2 flex-wrap items-center">
              ...
              >
                <Link
                  href="/contact"
                  className="px-6 py-3 border border-indigo-400 text-indigo-400 hover:bg-indigo-500 hover:text-white rounded-lg flex items-center gap-2 transition duration-300"
                >
                  <FiSend /> Hire Me
                </Link>
              </motion.div>
