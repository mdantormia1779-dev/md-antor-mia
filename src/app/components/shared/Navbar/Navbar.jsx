...
const Navbar = () => {
  const handleDownload = async () => {
    // ১. ক্লিক কাউন্ট আপডেট করার জন্য API কল
    try {
      ...
      <div className="navbar container mx-auto text-white">
        ...
        <div className="navbar-end">
          <button
            ...
            className="btn bg-indigo-500 hover:bg-indigo-600 text-white border-none rounded-lg flex items-center gap-2 shadow-lg shadow-indigo-500/20"
          >
            <FaDownload />
            Download CV
          </button>
